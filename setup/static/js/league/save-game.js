(function() {
    ...
    function getJogoData(index) {
        ...
        const pontosDupla1Input = document.querySelector(`input[name="jogo_set-${index}-placar_dupla1"]`);
        const pontosDupla2Input = document.querySelector(`input[name="jogo_set-${index}-placar_dupla2"]`);
    ...
    function init() {
        ...
        //     if (e.target.matches('input[name*="jogo_set-"][name*="-placar_dupla"]')) {
